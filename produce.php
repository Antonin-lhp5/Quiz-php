        ...
        <div class="bg-gray-700 p-5 ring-black ring-2 ring-opacity-10 shadow mb-20">
          <form action="" method="GET">
            <div>
              ...
              <input class="w-full p-2 mb-6 text-gray-200 outline-none bg-gray-800 ring-1 ring-gray-900 focus:ring-blue-600" type="text" name="nameQuiz" id="nameQuiz" placeholder="ex: L'origine de nos super-héros">
            </div>
            <div class="w-1/2">
